...
def displayEverything(hotels):
    for hotel in hotels:
        ...
        print('{:^70}'.format('\033[4m'+hotel.name+'\033[0m'))
...
driver = webdriver.PhantomJS('C:/Users/shivangi pandey/Anaconda3/phantomjs/phantomjs-2.1.1-windows/bin/phantomjs.exe')
